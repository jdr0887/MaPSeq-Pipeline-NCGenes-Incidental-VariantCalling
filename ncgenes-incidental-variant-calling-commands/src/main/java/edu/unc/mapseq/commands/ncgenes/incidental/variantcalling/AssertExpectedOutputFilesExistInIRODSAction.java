...
import edu.unc.mapseq.commons.ncgenes.incidental.variantcalling.AssertExpectedOutputFilesExistInIRODSRunnable;
import edu.unc.mapseq.dao.MaPSeqDAOBeanService;
import edu.unc.mapseq.dao.model.Sample;

@Command(scope = "ncgenes-incidental-variantcalling", name = "assert-expected-output-files-exist-in-irods")
@Service
