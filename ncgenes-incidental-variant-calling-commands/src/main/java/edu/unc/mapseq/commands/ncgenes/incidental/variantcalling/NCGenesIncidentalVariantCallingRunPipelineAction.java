...
@Command(scope = "ncgenes-incdidental-variantcalling", name = "run-pipeline", description = "Run NCGenes Incidental Variant Calling Pipeline")
public class NCGenesIncidentalVariantCallingRunPipelineAction extends AbstractAction {
    ...
    public NCGenesIncidentalVariantCallingRunPipelineAction() {
        super();
    }
